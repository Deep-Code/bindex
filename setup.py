...
#
#     from prex import metadata
#
# However, when we do this, we also import `prex/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'prex_cli = bindex.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'prex_gui = prex.gui:entry_point'
        # ]
    }
)
